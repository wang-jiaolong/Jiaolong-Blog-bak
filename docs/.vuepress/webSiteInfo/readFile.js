export const fs = require('fs'); // 文件模块
export const path = require('path'); // 路径模块
export const matter = require('gray-matter'); // FrontMatter解析器 https://github.com/jonschlinkert/gray-matter
export const chalk = require('chalk') // 命令行打印美化
export const log = console.log
export const docsRoot = path.join(__dirname, '..', '..', '..', 'docs'); // docs文件路径

/**
 * 获取本站的文章数据
 * 获取所有的 md 文档，可以排除指定目录下的文档
 */
 export function readFileList(excludeFiles = [''], dir = docsRoot, filesList = []) {
 ...
 * 可以排除某个目录下的 md 文档字数
 */
 export function readTotalFileWords(excludeFiles = ['']) {
 ...
 * 可以排除某个目录下的 md 文档字数
 */
 export function readEachFileWords(excludeFiles = [''], cn, en) {
