...
![image-20220901232553338](assets/image-20220901232553338.png)![image-20220902143433901](assets/image-20220902143433901.png)
...
![image-20220902151228461](assets/image-20220902151228461.png)
...
提供了一组指令，允许快速配置vl和vtype中的值，以匹配应用程序的需要。vset (i)vl(i)指令根据参数设置vtype和vl csr，并将vl的新值写入rd。

![image-20220902155527634](assets/image-20220902155527634.png)

### 6.1. vtype encoding

![image-20220902160823932](assets/image-20220902160823932.png)

新的vtype设置编码在vsetvli和vsetivli的直接字段中，以及vsetvl的rs2寄存器中。

在vset指令中，vtype被完整载入，。在汇编中使用一些固定的字符表示特定的配置。

![image-20220902160912330](assets/image-20220902160912330.png)
...
![image-20220902161308283](assets/image-20220902161308283.png)
...
![image-20220902162642502](assets/image-20220902162642502.png)
